  ...
  return (
    <div className={clsx('flex items-center justify-center gap-2', className)}>
      <button
        ...
        className="px-4 py-2.5 text-sm font-medium rounded-full border border-neutral-300/80 text-neutral-800 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-1.5 shadow-[0_1px_2px_0_rgba(0,0,0,0.05)] hover:shadow-[0_4px_6px_-1px_rgba(0,0,0,0.1),0_2px_4px_-1px_rgba(0,0,0,0.06)] hover:scale-105 active:scale-95 cursor-pointer disabled:hover:scale-100 bg-surface-panel enabled:hover:bg-surface-hover"
      >
        ...
        return (
          <button
            ...
            className={clsx(
              ...
              !isActive &&
                !isEllipsis &&
                'text-neutral-800 border-neutral-300/80 bg-surface-panel hover:bg-surface-hover shadow-[0_1px_2px_0_rgba(0,0,0,0.05)] hover:shadow-[0_4px_6px_-1px_rgba(0,0,0,0.1),0_2px_4px_-1px_rgba(0,0,0,0.06)] hover:scale-105 active:scale-95 cursor-pointer',
            )}
          >
            {page}
          </button>

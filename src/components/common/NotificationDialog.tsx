  ...
  const overlayContent = (
    ...
    >
      ...
      >
        {/* Header */}
        <div
          className={`flex items-center justify-between p-6 border-b border-neutral-200/80 ${headerBg}`}
        >
        ...
        <div className="overflow-y-auto p-6">
          ...
          >
            <div className="flex flex-col items-center gap-4 mb-2">
              <div className={`p-3 ${iconBg} rounded-full flex-shrink-0 shadow-sm`}>{icon}</div>

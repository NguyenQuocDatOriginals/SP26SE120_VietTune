...
import { getLocalRecordingMetaList, getLocalRecordingFull, setLocalRecording, removeLocalRecording } from "@/services/recordingStorage";
        ...
        (async () => {
            try {
                ...
                if (migrated) {
                    ...
                    const { audioData: _a, videoData: _v, ...metaOnly } = migrated as any;
                    setAllItems(prev => {
                                        ...
                                        items.filter((it) => it.id).map((it) => {
                                            ...
                                            return (
                                                <div
                                                    ...
                                                    className={`p-4 border-b border-neutral-200/80 cursor-pointer transition-colors border-l-4 ${borderColor} ${selectedId === it.id ? "bg-primary-50/80" : "hover:bg-neutral-50"
                                                        }`}
                                                >

        ...
        <div className="prose max-w-none space-y-6">
          ...
          <div className="rounded-2xl border border-neutral-200/80 shadow-lg backdrop-blur-sm p-8 transition-all duration-300 hover:shadow-xl" style={{ backgroundColor: '#FFFCF5' }}>
            ...
            <div className="space-y-3 text-neutral-700">
              ...
              <p className="leading-relaxed">
                <strong>1.2. "Người dùng"</strong>: Cá nhân hoặc tổ chức truy cập, đăng ký và/hoặc sử dụng Nền tảng, bao gồm nhưng không giới hạn ở người đóng góp nội dung, người nghiên cứu và người xem.
              </p>
              <p className="leading-relaxed">
                <strong>1.3. "Nội dung"</strong>: Toàn bộ dữ liệu, thông tin, tài liệu được tải lên, chia sẻ hoặc công bố trên Nền tảng, bao gồm nhưng không giới hạn ở: bản ghi âm thanh, hình ảnh, video, văn bản mô tả, siêu dữ liệu và bình luận.
              </p>
              <p className="leading-relaxed">
                <strong>1.4. "Di sản văn hóa phi vật thể"</strong>: Các giá trị văn hóa truyền thống được truyền từ thế hệ này sang thế hệ khác, bao gồm âm nhạc, bài hát, điệu múa, nghi lễ và các hình thức biểu đạt văn hóa của 54 dân tộc Việt Nam.
              </p>
              <p className="leading-relaxed">
                <strong>1.5. "Quản trị viên"</strong>: Cá nhân được VietTune ủy quyền quản lý, kiểm duyệt và xác minh nội dung trên Nền tảng.
              </p>
              <p className="leading-relaxed">
                <strong>1.6. "Tài khoản"</strong>: Hồ sơ điện tử được tạo lập khi Người dùng đăng ký sử dụng Nền tảng, bao gồm thông tin định danh và quyền truy cập tương ứng.
              </p>
            </div>
          </div>
          ...
          <div className="rounded-2xl border border-neutral-200/80 shadow-lg backdrop-blur-sm p-8 transition-all duration-300 hover:shadow-xl" style={{ backgroundColor: '#FFFCF5' }}>
            ...
            <div className="space-y-3 text-neutral-700">
              ...
              <p className="leading-relaxed">
                <strong>2.2. Đối tượng áp dụng:</strong> Văn bản này áp dụng cho tất cả cá nhân, tổ chức truy cập và sử dụng Nền tảng, không phân biệt mục đích sử dụng hay phương thức truy cập.
              </p>
              <p className="leading-relaxed">
                <strong>2.3. Hiệu lực:</strong> Điều khoản và Điều kiện này có hiệu lực kể từ thời điểm Người dùng lần đầu truy cập Nền tảng và duy trì hiệu lực trong suốt thời gian sử dụng.
              </p>
              <p className="leading-relaxed">
                <strong>2.4. Nguyên tắc cơ bản:</strong> VietTune hoạt động trên nguyên tắc phi lợi nhuận, hướng đến mục tiêu bảo tồn và phát huy giá trị di sản văn hóa phi vật thể của các dân tộc Việt Nam.
              </p>
            </div>
          </div>
          ...
          <div className="rounded-2xl border border-neutral-200/80 shadow-lg backdrop-blur-sm p-8 transition-all duration-300 hover:shadow-xl" style={{ backgroundColor: '#FFFCF5' }}>
            ...
            <div className="space-y-3 text-neutral-700">
              ...
              <p className="leading-relaxed">
                <strong>3.3.</strong> VietTune cam kết hoạt động minh bạch, tôn trọng bản sắc văn hóa và quyền lợi của các cộng đồng dân tộc là chủ nhân của di sản văn hóa.
              </p>
            </div>
          </div>
          ...
          <div className="rounded-2xl border border-neutral-200/80 shadow-lg backdrop-blur-sm p-8 transition-all duration-300 hover:shadow-xl" style={{ backgroundColor: '#FFFCF5' }}>
            ...
            <div className="space-y-3 text-neutral-700">
              ...
              <p className="leading-relaxed">
                <strong>4.4. Quyền của VietTune:</strong> VietTune có quyền từ chối đăng ký, tạm khóa hoặc xóa Tài khoản vi phạm các điều khoản này mà không cần thông báo trước.
              </p>
            </div>
          </div>
          ...
          <div className="rounded-2xl border border-neutral-200/80 shadow-lg backdrop-blur-sm p-8 transition-all duration-300 hover:shadow-xl" style={{ backgroundColor: '#FFFCF5' }}>
            ...
            <div className="space-y-3 text-neutral-700">
              ...
              <p className="leading-relaxed">
                <strong>5.2. Cam kết của Người đóng góp:</strong> Khi tải Nội dung lên Nền tảng, Người dùng cam kết và bảo đảm:
              </p>
              <ul className="list-disc list-inside space-y-1 ml-4">
          ...
          <div className="rounded-2xl border border-neutral-200/80 shadow-lg backdrop-blur-sm p-8 transition-all duration-300 hover:shadow-xl" style={{ backgroundColor: '#FFFCF5' }}>
            ...
            <div className="space-y-3 text-neutral-700">
              ...
              <p className="leading-relaxed">
                <strong>6.2. Giấy phép sử dụng:</strong> Bằng việc đóng góp Nội dung, Người dùng cấp cho VietTune giấy phép không độc quyền, không thể thu hồi, miễn phí bản quyền, có hiệu lực toàn cầu để:
              </p>
              <ul className="list-disc list-inside space-y-1 ml-4">
              ...
              <p className="leading-relaxed">
                <strong>6.3. Tôn trọng di sản cộng đồng:</strong> VietTune thừa nhận và tôn trọng quyền của các cộng đồng dân tộc đối với di sản văn hóa phi vật thể của họ. Nền tảng cam kết:
              </p>
              <ul className="list-disc list-inside space-y-1 ml-4">
              ...
              <p className="leading-relaxed">
                <strong>6.4. Quyền sở hữu của VietTune:</strong> VietTune sở hữu độc quyền các quyền sở hữu trí tuệ đối với: giao diện, thiết kế, mã nguồn, thuật toán, cơ sở dữ liệu tổng hợp và các yếu tố đặc trưng khác của Nền tảng.
              </p>
            </div>
          </div>
          ...
          <div className="rounded-2xl border border-neutral-200/80 shadow-lg backdrop-blur-sm p-8 transition-all duration-300 hover:shadow-xl" style={{ backgroundColor: '#FFFCF5' }}>
            ...
            <div className="space-y-3 text-neutral-700">
              ...
              <p className="leading-relaxed">
                <strong>7.4. Phân loại Nội dung:</strong> Nội dung trên Nền tảng được phân loại theo trạng thái xác minh: "Đã xác minh", "Chờ xác minh" và "Cần bổ sung thông tin".
              </p>
            </div>
          </div>
          ...
          <div className="rounded-2xl border border-neutral-200/80 shadow-lg backdrop-blur-sm p-8 transition-all duration-300 hover:shadow-xl" style={{ backgroundColor: '#FFFCF5' }}>
            ...
            <div className="space-y-3 text-neutral-700">
              ...
              <p className="leading-relaxed">
                <strong>8.2. Thu thập dữ liệu:</strong> VietTune thu thập dữ liệu cá nhân cần thiết cho việc:
              </p>
              <ul className="list-disc list-inside space-y-1 ml-4">
              ...
              <p className="leading-relaxed">
                <strong>8.3. Nguyên tắc xử lý:</strong> Dữ liệu cá nhân được xử lý theo các nguyên tắc:
              </p>
              <ul className="list-disc list-inside space-y-1 ml-4">
              ...
              <p className="leading-relaxed">
                <strong>8.4. Quyền của Người dùng:</strong> Người dùng có quyền yêu cầu truy cập, chỉnh sửa, xóa dữ liệu cá nhân theo quy định của pháp luật.
              </p>
            </div>
          </div>
          ...
          <div className="rounded-2xl border border-neutral-200/80 shadow-lg backdrop-blur-sm p-8 transition-all duration-300 hover:shadow-xl" style={{ backgroundColor: '#FFFCF5' }}>
            ...
            <div className="space-y-3 text-neutral-700 mb-6">
              <p className="leading-relaxed">
                <strong>11.1. Nguyên tắc ghi nhận:</strong> Khi sử dụng Nội dung từ VietTune cho nghiên cứu, giáo dục hoặc các mục đích phi thương mại được phép, Người dùng phải ghi nhận đầy đủ nguồn.
              </p>
              <p className="leading-relaxed">
              ...
              <p className="leading-relaxed">
                <strong>11.3. Định dạng trích dẫn đề xuất:</strong> "[Tên bản thu]. Người đóng góp: [Tên]. Nghệ nhân: [Tên]. Dân tộc: [Tên dân tộc]. VietTune, [URL]. Truy cập ngày [dd/mm/yyyy]."
              </p>
            </div>
            ...
            <div className="space-y-3 text-neutral-700 mb-6">
              <p className="leading-relaxed">
                <strong>12.1.</strong> Nền tảng VietTune được cung cấp trên cơ sở "nguyên trạng" (as is) và "sẵn có" (as available). VietTune không đưa ra bất kỳ bảo đảm nào, dù rõ ràng hay ngầm định.
              </p>
              <p className="leading-relaxed">
                <strong>12.2.</strong> Mặc dù VietTune nỗ lực xác minh Nội dung, chúng tôi không thể bảo đảm tính chính xác tuyệt đối của thông tin văn hóa, lịch sử được cung cấp bởi cộng đồng.
              </p>
            </div>
            ...
            <div className="space-y-3 text-neutral-700 mb-6">
              <p className="leading-relaxed">
                Trong phạm vi pháp luật cho phép, VietTune và các bên liên quan sẽ không chịu trách nhiệm về thiệt hại trực tiếp, gián tiếp, ngẫu nhiên, đặc biệt hoặc hệ quả phát sinh từ việc sử dụng Nền tảng.
              </p>
            </div>
            ...
            <div className="space-y-3 text-neutral-700 mb-6">
              <p className="leading-relaxed">
                <strong>14.</strong> Người dùng đồng ý bồi thường và bảo vệ VietTune khỏi mọi khiếu nại phát sinh từ vi phạm Điều khoản này.
              </p>
              <p className="leading-relaxed">
                <strong>15.</strong> VietTune có quyền sửa đổi Điều khoản này vào bất kỳ thời điểm nào. Thay đổi sẽ được thông báo qua email hoặc trên Nền tảng.
              </p>
              <p className="leading-relaxed">
                <strong>16.</strong> Người dùng có thể chấm dứt Tài khoản bất kỳ lúc nào. VietTune có quyền tạm ngừng hoặc chấm dứt Tài khoản vi phạm mà không cần thông báo trước.
              </p>
            </div>
            ...
            <div className="space-y-3 text-neutral-700">
              ...
              <p className="leading-relaxed">
                <strong>18. Điều khoản tách rời:</strong> Nếu điều khoản nào bị vô hiệu, các điều khoản còn lại vẫn có hiệu lực.
              </p>
              <p className="leading-relaxed">
                <strong>19. Toàn bộ thỏa thuận:</strong> Văn bản này cấu thành toàn bộ thỏa thuận giữa Người dùng và VietTune.
              </p>
              <p className="leading-relaxed">
          ...
          <div className="rounded-2xl shadow-md border border-neutral-200 p-6" style={{ backgroundColor: '#FFFCF5' }}>
            ...
            <p className="text-neutral-600 mt-3 italic">
              Bằng việc tiếp tục sử dụng Nền tảng VietTune, Người dùng xác nhận đã đọc, hiểu rõ và đồng ý ràng buộc bởi toàn bộ nội dung của Điều khoản và Điều kiện này.
            </p>
          </div>
        </div>
      </div>

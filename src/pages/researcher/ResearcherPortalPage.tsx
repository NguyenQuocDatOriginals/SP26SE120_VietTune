...
function highlightTranscriptDiff(
  left: string,
  right: string,
...
export default function ResearcherPortalPage() {
  ...
  const handleExportDataset = useCallback(() => {
    ...
    const blob = new Blob(
      [
        JSON.stringify(
          { exportedAt: new Date().toISOString(), total: payload.length, recordings: payload },
          null,
          2,
        ),
      ],
  ...
  const pushAiResponseForExpertReview = useCallback(
    async (question: string, answer: string, citations?: ChatCitation[]) => {
      try {
  ...
  return (
    <div className="min-h-screen min-w-0 bg-gradient-to-b from-cream-50 via-[#F9F5EF] to-secondary-50/35">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Tabs */}
        <div className="rounded-2xl border border-secondary-200/50 bg-gradient-to-br from-[#FFFCF5] to-secondary-50/55 shadow-lg backdrop-blur-sm mb-6 sm:mb-8 transition-all duration-300 hover:shadow-xl min-w-0 overflow-x-hidden">
          <nav
                ...
                <div className="mb-4 sm:mb-5 flex items-start justify-between gap-3">
                  <div>
                    ...
                    <p className="text-xs text-neutral-500 mt-1">
                      Lọc nhanh theo metadata đã xác minh.
                    </p>
                    {activeFilterCount > 0 && (
                ...
                <div className="space-y-4">
                  {approvedRecordings.length === 0 ? (
                    <p className="text-neutral-600 py-8 text-center">
                      Không có bản thu nào khớp với bộ lọc hoặc từ khóa. Chỉ hiển thị bản thu đã
            ...
            <div className="p-4 sm:p-6 lg:p-8">
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                                  ...
                                  {msg.citations.map((c, cidx) => (
                                    <li key={`${idx}-cite-${cidx}`}>
                                      <button
                                        ...
                                        onClick={() =>
                                          handleDetail(
                                            approvedRecordings.find(
                                              (x) => x.id === c.recordingId,
                                            ) ?? c.recordingId,
                                          )
                                        }
                ...
                <div className="flex flex-col gap-4">
                  <div className="rounded-2xl border border-secondary-200/50 bg-gradient-to-br from-[#FFFCF5] via-cream-50/80 to-secondary-50/50 shadow-lg backdrop-blur-sm p-4">
            ...
            <div className="p-4 sm:p-6 lg:p-8 space-y-6">
                    ...
                    <div className="rounded-xl border-2 border-secondary-200/80 bg-white p-4 shadow-sm max-h-[min(500px,60vh)] overflow-y-auto">
                      ...
                      {((graphView === 'instruments' && instrumentsList.length === 0) ||
                        ...
                        <p className="text-neutral-500 text-xs">
                          Chưa có dữ liệu từ bản thu đã kiểm duyệt.
                        </p>
                      )}
                    </div>
              ...
              {(graphView === 'instruments' || graphView === 'ethnicity') &&
                ...
                selectedGraphNode.type ===
                  (graphView === 'instruments' ? 'instrument' : 'ethnicity') && (
                  <div className="rounded-2xl border border-secondary-200/50 bg-gradient-to-br from-[#FFFCF5] via-cream-50/80 to-secondary-50/50 shadow-lg backdrop-blur-sm p-4 sm:p-6">
                    ...
                    {graphRelatedRecordings.length === 0 ? (
                      <p className="text-sm text-neutral-600">
                        Chưa có bản thu phù hợp với nút đã chọn.
                      </p>
                    ) : (
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                {[
                  ...
                  },
                  {
                    ...
                    className:
                      'bg-gradient-to-br from-emerald-50 to-green-50 border-emerald-200/80',
          ...
          {activeTab === 'compare' &&
            (() => {
                  ...
                  <div className="mt-4 rounded-lg bg-white border border-primary-200/80 p-3">
                    ...
                    {!rec ? (
                      <p className="text-neutral-500 text-sm py-4 text-center">
                        Chọn bản thu để xem metadata và phát
                      </p>
                    ) : (
                      <div className="mt-3 space-y-1.5 text-sm">
                        ...
                        <div className="flex justify-between">
                          ...
                          <span className="font-semibold text-primary-800">
                            {rec.region
                              ? REGION_NAMES[rec.region as keyof typeof REGION_NAMES]
                              : '—'}
                          </span>
                        </div>
                        <div className="flex justify-between">
              ...
              return (
                <div className="p-4 sm:p-6 lg:p-8 space-y-6">
                  <div className="rounded-2xl border border-secondary-200/50 bg-gradient-to-br from-[#FFFCF5] via-cream-50/80 to-secondary-50/50 shadow-lg backdrop-blur-sm p-4 sm:p-6">
                    <h2 className="text-lg sm:text-xl font-semibold text-primary-800 mb-2">
                      So sánh phân tích
                    </h2>
                    <p className="text-sm text-neutral-600 mb-6">
                      Chọn hai bản thu để xem metadata và nghe song song (mở modal phát từng bản).
                    </p>
                  ...
                  <div className="rounded-2xl border border-secondary-200/50 bg-gradient-to-br from-[#FFFCF5] via-cream-50/80 to-secondary-50/50 shadow-lg backdrop-blur-sm p-4 sm:p-6">
                    ...
                    {expertNotes.length === 0 ? (
                      <p className="text-sm text-neutral-600">
                        Chọn đủ 2 bản thu để hệ thống gợi ý nhận xét so sánh theo metadata đã kiểm
                        duyệt.
                      </p>
                    ) : (

...
namespace VietTuneArchive.API.Controllers
{
    ...
    public class CommuneController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<PagedResponse<CommuneDto>>> GetAll(
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<ServiceResponse<CommuneDto>>> GetById(Guid id)
        {
        ...
        [HttpPut("{id}")]
        public async Task<ActionResult<ServiceResponse<CommuneDto>>> Update(Guid id, [FromBody] CommuneDto dto)
        {

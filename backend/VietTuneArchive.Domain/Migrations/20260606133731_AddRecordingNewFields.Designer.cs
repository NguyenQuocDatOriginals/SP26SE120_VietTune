...
namespace VietTuneArchive.Domain.Context.Migrations
{
    ...
    [Migration("20260606133731_AddRecordingNewFields")]
    partial class AddRecordingNewFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VietTuneArchive.Domain.Entities.CopyrightDispute", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("VietTuneArchive.Domain.Entities.Embargo", b =>
                {
                    ...
                    b.Property<DateTime?>("EmbargoEndDate")
                        .HasColumnType("timestamp without time zone");

                    b.Property<DateTime?>("EmbargoStartDate")
                        .HasColumnType("timestamp without time zone");
            ...
            modelBuilder.Entity("VietTuneArchive.Domain.Entities.Recording", b =>
                {
                    ...
                    b.Property<string>("RecordingLocation")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)");
            ...
            modelBuilder.Entity("VietTuneArchive.Domain.Entities.CopyrightDispute", b =>
                {
                    b.HasOne("VietTuneArchive.Domain.Entities.User", "AssignedReviewer")
                        .WithMany()
                    ...
                    b.HasOne("VietTuneArchive.Domain.Entities.User", "ReportedByUser")
                        .WithMany()

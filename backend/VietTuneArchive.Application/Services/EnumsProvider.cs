...
namespace VietTuneArchive.Application.Services
{
    public class EnumsProvider : IEnumsProvider
    {
        ...
        // ✅ Option 1: Implement properly if you need structured output
        ...
        // ✅ Option 2: Remove from interface if not needed
        // Just delete BuildAISchema() and remove it from IEnumsProvider interface
    }
}

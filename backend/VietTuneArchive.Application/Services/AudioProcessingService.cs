...
namespace VietTuneArchive.Application.Services
{
    public class AudioProcessingService : IAudioProcessingService
    {
        ...
        private readonly IEnumsProvider _enumsProvider;
        ...
        public async Task<UploadResultDto> UploadToCloudAsync(IFormFile audioFile, string userId)
        {
            _logger.LogInformation("Service: Uploading to storage for user {UserId}", userId);
            return await _uploadService.UploadAsync(audioFile, userId);
        }
        ...
        public async Task<AudioProcessResultDto> ProcessAudioAsync(IFormFile audioFile, string userId)
        {
            ...
            var uploadTask = UploadToCloudAsync(audioFile, userId);
            var analyzeTask = AnalyzeAudioAsync(audioFile);

            await Task.WhenAll(uploadTask, analyzeTask);
